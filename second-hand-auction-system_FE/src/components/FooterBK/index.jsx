...
const FooterBK = () => {
    return (
        <footer className="px-10 bg-green-a700 divide-y dark:bg-gray-100 dark:text-gray-800">
            <div className="container flex flex-row justify-around py-10 mx-auto space-y-8 lg:flex-col lg:space-y-0">
                ...
                <div className="grid grid-cols-4 text-sm gap-x-36 gap-y-8 lg:w-2/3 sm:grid-cols-4">
