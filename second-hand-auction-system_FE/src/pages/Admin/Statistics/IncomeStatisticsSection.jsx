                    ...
                    <div className="ml-[18px] flex items-start md:ml-0 sm:flex-col">
                        ...
                        <div className="flex flex-1 justify-end sm:self-stretch">
                            ...
                            <SelectBox
                                ...
                                indicator={
                                    <Img src="images/img_checkmark_blue_gray_900.svg" alt="Checkmark" className="h-[14px] w-[14px]" />
                                }
                            ...
                            <div className="relative h-[310px] md:h-auto">
                                <div className="flex-1">
                                    ...
                                    <div className="relative mt-[-66px] flex flex-col items-start gap-9">
                                        <Text size="textxs" as="p" className="text-[13px] font-normal text-blue_gray-700">
                                            50
                                        </Text>
                                        <Text size="textxs" as="p" className="text-[13px] font-normal text-blue_gray-700">
                                            0
                ...
                <div className="w-[38%] rounded-[16px] bg-bg-white py-10 shadow-xs md:w-full sm:py-5">
                    <div className="mb-[174px] flex flex-col gap-[70px] md:gap-[52px] sm:gap-[35px]">
                        <div className="flex items-start justify-between gap-5">
                            <Heading size="textxl" as="h4" className="ml-6 text-[18px] font-medium uppercase text-blue_gray-900">
                                THU NHẬP
                            </Heading>
                            <SelectBox
                                shape="round"
                            ...
                            <div className="mt-6 flex w-[26%] flex-col gap-[26px]">
                                <div className="flex flex-col items-start">
                                    <div className="flex items-start gap-2.5 self-stretch">
                                        ...
                                        <Text as="p" className="self-center text-[15px] font-medium text-blue_gray-900">
                                            Thu nhập
                                        </Text>
                                    </div>
                                    <Text size="texts" as="p" className="ml-[22px] text-[14px] font-normal text-blue_gray-600_b2 md:ml-0">
                                        80%
                                    </Text>
                                </div>
                                <div className="flex items-start gap-2.5">
                                    ...
                                    <div className="flex flex-1 flex-col items-start self-center">
                                        <Text as="p" className="text-[15px] font-medium text-blue_gray-900">
                                            Phí
                                        </Text>
                                        <Text size="texts" as="p" className="text-[14px] font-normal text-blue_gray-600_b2">
                                            20%
                                        </Text>
                                    </div>
                                </div>
