            ...
            tableColumnHelper.accessor("idRow", {
                cell: (info) => (
                    <div className="flex flex-col items-center px-1">
                        <Text as="p" className="mb-8 text-[15px] font-normal text-blue_gray-900">
                            {info.getValue()}
                        </Text>
                    </div>
                ),
            ...
            tableColumnHelper.accessor("productRow", {
                cell: (info) => (
                    <div className="ml-14 flex flex-1">
                        <Text as="p" className="mb-9 text-[15px] font-normal text-blue_gray-900">
                            {info.getValue()}
                        </Text>
                    </div>
                ),
            ...
            tableColumnHelper.accessor("dateRow", {
                cell: (info) => (
                    <div className="flex flex-1 justify-center">
                        <Text as="p" className="mb-[34px] text-[15px] font-normal text-blue_gray-900">
                            {info.getValue()}
                        </Text>
                    </div>
                ),
        ...
        <>
            ...
            <div className="px-1">
                <div className="flex flex-col items-start gap-14 rounded-[16px] bg-bg-white py-9 shadow-xs sm:gap-7 sm:py-5">
                    <Heading size="textxl" as="h6" className="ml-8 text-[18px] font-medium uppercase text-blue_gray-900 md:ml-0">
                        đơn hàng gần đây
                    </Heading>
                    <ReactTable1
                        size="xs"
