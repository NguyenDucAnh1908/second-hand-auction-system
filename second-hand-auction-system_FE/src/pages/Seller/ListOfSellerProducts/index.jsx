            ...
            tableColumnHelper.accessor("idHeaderRow", {
                ...
                header: (info) => (
                    <div className="flex justify-center py-4">
                        <Heading as="h2" className="mb-1.5 text-[16px] font-medium text-blue_gray-900_01">
                            ID
                        </Heading>
                    </div>
                ),
            ...
            tableColumnHelper.accessor("productHeaderRow", {
                cell: (info) => (
                    <div className="ml-5 flex flex-1 justify-center px-5">
                        <Text as="p" className="mb-6 text-[15px] font-normal text-blue_gray-900_01">
                            {info.getValue()}
                        </Text>
                    </div>
                ),
                header: (info) => (
                    <div className="ml-5 flex justify-center p-4">
                        <Heading as="h3" className="mb-1.5 text-[16px] font-medium text-blue_gray-900_01">
                            Sản phẩm
                        </Heading>
                    </div>
                ),
            ...
            tableColumnHelper.accessor("imageHeaderRow", {
                cell: (info) => (
                    <div className="ml-7 flex px-7 sm:px-5">
                        <Img src={info.getValue()} alt="Product Image" className="mb-2.5 h-[80px] w-[80px] object-cover" />
                    </div>
                ),
                header: (info) => (
                    <div className="ml-7 flex justify-center p-3.5">
                        <Heading as="h4" className="mb-2.5 text-[16px] font-medium text-blue_gray-900_01">
                            Hình ảnh
                        </Heading>
                    </div>
                ),
            ...
            tableColumnHelper.accessor("timeHeaderRow", {
                ...
                header: (info) => (
                    <div className="ml-12 flex flex-row justify-start px-[30px] py-[18px] sm:px-5">
                        <Heading as="h5" className="mb-1 text-[16px] font-medium text-blue_gray-900_01">
                            Thời gian
                        </Heading>
                    </div>
                ),
                ...
                cell: (info) => (
                    <div className="ml-4 px-1">
                        <div className="mb-[30px] ml-2 flex justify-center md:ml-0">
                            <Img src="images/img_edit.png" alt="Edit Icon" className="h-[40px]" />
                            <Img src="images/img_delete.png" alt="Delete Icon" className="h-[40px]" />
                        </div>
                    </div>
                ),
                header: (info) => (
                    <div className="ml-4 flex py-4">
                        <Heading as="p" className="mb-1.5 text-[16px] font-medium text-blue_gray-900_01">
                            Chỉnh sửa
                        </Heading>
                    </div>
                ),
                                ...
                                <div className="mb-[86px] flex flex-col gap-7" >
                                    ...
                                    <div className=" mr-[38px] flex justify-between gap-5 md:mx-0 sm:flex-col -mt-[50px] ml-[15px]">
                                        ...
                                        <ButtonDH
                                            ...
                                            className="flex h-[40px] min-w-[152px] flex-row items-center justify-center gap-0.5 rounded-md bg-green-a700  text-center text-[14px] text-bg-white shadow-xs ml-auto"
                                        >
                                            Tạo sản phẩm
                                        </ButtonDH>
                                    </div>
