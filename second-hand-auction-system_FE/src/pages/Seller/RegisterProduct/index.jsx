...
import { ButtonDH, Img, Text, Heading, SelectBox, InputDH, TextArea } from "../../../components";
            ...
            <div className="flex w-full flex-col items-center gap-[132px] bg-bg-white md:gap-[99px] sm:gap-[66px]">
                ...
                <div className=" w-[100%] md:w-full md:px-5 ">
                    ...
                    <div className="flex">
                        ...
                        <div className={`transition-all duration-300 ${isSidebarVisible ? 'w-[25%]' : 'hidden'}`}>
                            <SidebarSeller />
                        </div>

                        <div className={`transition-all duration-300 ${isSidebarVisible ? 'w-[75%]' : 'w-full'}`}>
                                            ...
                                            <div className="flex gap-[30px] self-stretch md:flex-col">
                                                <div className="flex flex-1 flex-col gap-[34px] md:self-stretch">
                                                    <div className=" flex flex-col items-start justify-center gap-1.5 md:mx-0">
                                                        <Heading as="h3" className="font-jost text-[16px] font-medium text-blue_gray-900">
                                                            Tiêu đề
                                                        </Heading>
                                                        <InputDH
                                                            shape="round"
                                                    ...
                                                    <div className=" flex flex-col items-start justify-center gap-1.5 md:mx-0">
                                                        <Heading as="h4" className="font-jost text-[16px] font-medium text-blue_gray-900">
                                                            Tên sản phẩm
                                                        </Heading>
                                                        <InputDH
                                                            shape="round"
                                                    ...
                                                    <div className="flex flex-col items-start justify-center gap-1 md:mx-0">
                                                        <Heading as="h5" className="font-jost text-[16px] font-medium text-blue_gray-900">
                                                            Tên thương hiệu
                                                        </Heading>
                                                        <InputDH
                                                            shape="round"
                                                ...
                                                <div className="flex w-[44%] flex-col items-start md:w-full">
                                                    <Heading as="p" className="ml-3 font-jost text-[16px] font-medium text-black-900 md:ml-0">
                                                        Hình ảnh sản phẩm
                                                    </Heading>
                                                    ...
                                                    <div className="mt-11 flex flex-col items-start gap-1.5 self-stretch">
                                                        ...
                                                        <div className="flex items-center gap-[21px] self-stretch rounded-[20px] bg-blue-200_01 px-7 py-1.5 sm:px-5">
                                                            ...
                                                            />
                                                            <Heading as="p" className="font-jost text-[16px] font-medium text-black-900">
                                                    ...
                                                    <div className="mt-[42px] flex flex-col gap-3 self-stretch ">
                                                        <div className="flex flex-col items-start justify-center gap-1 w-[50%] bg-white">
                                                            ...
                                                            <SelectBox
                                                                shape="round"
                                                                indicator={
                                                                    <Img src="images/img_arrowdown.svg" alt="Arrow Down" className="h-[18px] w-[18px]" />
                                                                }
                                                ...
                                                <div className="flex w-full flex-col items-end gap-5">
                                                    ...
                                                    <div className="flex w-[86%] flex-col items-start justify-center gap-1 md:w-full">
                                                        ...
                                                        <InputDH
                                                            ...
                                                            suffix={
                                                                <Text className="w-[32px] font-jost text-[15px] font-normal text-colors">VND</Text>
                                                            }
                                        ...
                                        <div className="flex flex-col items-center gap-[62px] sm:gap-[31px]">
                                            <div className="flex flex-col items-center self-stretch">
                                                ...
                                                <div className="mt-9 flex items-start justify-center gap-5 self-stretch md:flex-col">
                                                    ...
                                                    >
                                                        Tôi cam kết rằng mọi thông tin cá nhân và dữ liệu liên quan đến sản phẩm của tôi sẽ được bảo
                                                        mật và không bị tiết lộ cho bên thứ ba mà không có sự đồng ý của tôi.
                                                    </Text>
                                                </div>
                                                <div className="mr-4 mt-2 flex items-start justify-center gap-5 self-stretch md:mr-0 md:flex-col">
                                                    ...
                                                    >
                                                        Tôi xác nhận rằng tất cả thông tin, hình ảnh và mô tả sản phẩm mà tôi cung cấp là chính xác,
                                                        đầy đủ và không gây hiểu nhầm cho người mua. Tôi sẽ chịu trách nhiệm về tính chính xác của
                                                        thông tin này.
                                                    </Text>
                                                </div>
                                                <div className="mr-[18px] mt-6 flex items-start justify-center gap-5 self-stretch md:mr-0 md:flex-col">
                                                    ...
                                                    <Text
                                                        ...
                                                        className="w-[96%] self-center text-[14px] font-normal leading-[150%] text-black-900 md:w-full"
                                                    >
                                                        Tôi cam kết tuân thủ tất cả các quy định và điều khoản mà hệ thống đặt ra, bao gồm nhưng
                                                        không giới hạn ở quy trình đăng bán, thẩm định sản phẩm và quy trình giao dịch.
                                                    </Text>
                                                </div>
                                                <div className="mt-3 flex items-center justify-center self-stretch md:flex-col">
                                                    ...
                                                    <div className="flex flex-1 justify-between gap-5 md:self-stretch">
                                                        ...
                                                        <ButtonDH shape="round" className="min-w-[256px] rounded-[16px] font-medium">
                                                            Thông tin seller:
                                                        </ButtonDH>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="flex w-[38%] justify-between gap-5 md:w-full">
                                                <ButtonDH size="md" className="min-w-[152px] rounded-md">
                                                    Gửi thẩm định
                                                </ButtonDH>
                                                <ButtonDH size="md" className="min-w-[152px] rounded-md">
                                                    Hủy bỏ
