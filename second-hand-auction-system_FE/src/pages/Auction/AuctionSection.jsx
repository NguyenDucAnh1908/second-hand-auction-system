...
export default function AuctionSection() {
    ...
    return (
        <>
            ...
            {/*TermsOfDelivery*/}
            <Modal title="TermsOfDelivery" open={isTermsOfDelivery} onOk={handleOkTermsOfDelivery} onCancel={handleCancelTermsOfDelivery}>
                <p>Some contents...</p>
                <p>Some contents...</p>
                <p>Some contents...</p>
            </Modal>
            ...
            <div className="mt-4 flex items-center gap-[50px] self-stretch px-[22px] md:flex-col sm:px-5">
                ...
                <div
                    ...
                    <Text size="textmd" as="p" className="mt-[22px] text-[11px] font-normal text-gray-900_01 self-stretch">
                    ...
                    <div className="mb-1.5 ml-1.5 mt-[22px] flex flex-col gap-5 self-stretch md:ml-0">
                        <Text size="textmd" as="p" className="mt-[2px] text-[11px] font-normal text-gray-900_01 self-stretch">
                        ...
                        <Text size="textmd" as="p" className="mt-[2px] text-[11px] font-normal text-gray-900_01 self-stretch">
                            <span className="font-bold">Phí Ship: </span> Phí vận chuyển có thể thay đổi
                            <button
                                type="button"
