                    ...
                    <div className="ml-[72px] flex w-[10%] flex-col gap-2.5 md:ml-0 md:w-full md:flex-row">
                        <Suspense fallback={<div>Loading feed...</div>}>
                            {thumbnailList.map((d, index) => (
                                <UserProfileImage {...d} key={"thumbnailList1" + index}
                ...
                <div
                    ...
                    <div className="mb-1.5 ml-1.5 mt-[22px] flex flex-col gap-5 self-stretch md:ml-0">
                        <div className="mr-1 flex items-center bg-bg-white md:mr-0">
                            <Img src="images/img_image_125.png" alt="Payment Icon 1"
                                 className="h-[10px] w-[18%] object-contain"/>
                            <Img src="images/img_paypal.png" alt="Payment Icon 2"
                                 className="ml-5 h-[10px] w-[18%] object-contain"/>
                            <Img src="images/img_images.png" alt="Payment Icon 3"
                                 className="ml-5 h-[28px] w-[16%] object-contain"/>
                        </div>
                        <div className="flex flex-wrap items-start gap-[22px]">
                            <Heading size="headingmd" as="h6"
                                     className="mb-1 text-[14px] font-bold text-blue_gray-900_01">
                                Trả về:
                            </Heading>
                        ...
                        <div className="flex flex-wrap gap-5">
                            <Heading size="headings" as="p"
                                     className="self-end text-[12px] font-bold text-blue_gray-900_01">
                                Phí ship:
                            </Heading>
