                    ...
                    <div className="flex w-full flex-col gap-7 md:px-5">
                        ...
                        <div className="flex items-start gap-12">
                            ...
                            <div className="relative h-[904px] flex-1">
                                <div
                                    className="absolute bottom-0 left-0 right-0 top-0 my-auto ml-1 mr-2 flex h-max flex-1 rounded-[16px] bg-gray-100 px-[22px] py-2.5 md:mx-0 sm:px-5">
                                    <Heading
                                        size="text3xl"
                                        as="h1"
                                ...
                                <div
                                    ...
                                    <div className="ml-3 flex items-center justify-between gap-5 md:ml-0 md:flex-col">
                                        <Input
                                            ...
                                            suffix={
                                                searchBarValue1?.length > 0 ? (
                                                    ...
                                                    <Img src="images/img_search.svg" alt="Search 1"
                                        ...
                                        <Button type="primary" onClick={showModal}
                                            ...
                                            <svg className="w-6 h-6 text-gray-800 dark:text-white me-2"
                                                 aria-hidden="true"
                                            ...
                                            <Suspense fallback={<div>Loading feed...</div>}>
                                                {addressList.map((d, index) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="text-gray-600">{d.userAddress}</div>
                                                        <div className="flex justify-between mt-2">
                                                            <Button type="primary" onClick={showUpdateAddress} className="text-white-a700_4c-500">Update</Button>
                                                            <Popconfirm
                                                                title="Delete the task"
                                                                description="Are you sure to delete this task?"
                                                                onConfirm={confirm}
